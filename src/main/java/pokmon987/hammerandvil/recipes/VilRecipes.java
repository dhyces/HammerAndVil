...
public class VilRecipes {
	...
	public void addVilRecipe(String name, ItemStack output, NonNullList<ItemStack> inputs, int hits, ItemStack... tool) {
	...
	public void addVilRecipe(String name, ItemStack output, NonNullList<ItemStack> inputs, int hits, List<ItemStack> tool) {
	...
	public static String getName(NonNullList<ItemStack> inputs, ItemStack tool) {
		for (VilRecipe entry : recipes) {
			if (entry.getInputs().containsAll(inputs) && entry.getTool().contains(tool)) {
